...
reticulate::use_condaenv("/Users/asabjor/miniconda3/envs/seurat5")
...
For all downstream integration we will use this set of genes so that it is comparable across the methods. We already used that set of genes in the dimensionality reduction exercise to run scaling and pca. But still, we will store the list in the object for future use.
