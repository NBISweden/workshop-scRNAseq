...
if (!file.exists(path_file)) download.file(url = file.path(path_data, "trajectory_seurat_filtered.rds"), destfile = path_file)
```
...
```{r}
path_file <- "data/trajectory/results/seurat_scegam.rds"
