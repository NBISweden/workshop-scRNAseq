...
#DIMERD_ALL8:Select some of your dimensionality reductions and plot some of the QC stats that were calculated in the previous lab. Can you see if some of the clusters/separation in your data is driven by quality of the cells? 
