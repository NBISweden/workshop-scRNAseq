...
#-----------
```{r setup, include=FALSE}
lab <- readLines(paste0(script_path,"/seurat/seurat_01_qc.Rmd"))
...
writeLines(t_lab,paste0(script_path,"/compiled/seurat/seurat_01_qc_compiled.Rmd"))
...
```{r setup, include=FALSE}
lab <- readLines(paste0(script_path,"/seurat/seurat_02_dim_reduction.Rmd"))
lab_text <- readLines(paste0(script_path,"/knit_labs.Rmd"))
...
writeLines(t_lab,paste0(script_path,"/compiled/seurat/seurat_02_dim_reduction_compiled.Rmd"))
```
#-----------
