...
You can either download individual .qmd/.pynb files from the [Contents](/home_contents.html) page or clone the whole repo. If you clone the repo, navigate to `compiled/labs`
