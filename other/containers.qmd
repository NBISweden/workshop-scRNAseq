...
In the browser, go to [localhost:8788](localhost:8788).  
...
In the browser, go to [localhost:8789](localhost:8789). Use the following credentials to log in to the RStudio Server:  
