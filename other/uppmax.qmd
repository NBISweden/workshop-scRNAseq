...
#| class-output: bash
#| echo: false
cat(paste0("touch /proj/​", ups, "/completed/username"))
```
...
#| class-output: bash
#| echo: false
cat(paste0("ls /proj/​", ups, "/nobackup/username"))
```

​It should write out the name of the file if the file exists. ​If you get an error message, please contact us. Email is on the [Info](/home_info.qmd) page.
