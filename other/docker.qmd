---
title: Docker
subtitle: Instructions on working in a docker container
date: ""
author: ""
code-tools: false
format: html
...
In the last case scenario, if you are having problems installing R packages, please follow these instructions to setup a docker container with R and Rstudio. Then you will need to install packages as usual. See the [precourse material](../home_precourse.qmd) for package installations.
...
![](https://github.com/NBISweden/single-cell_sib_scilifelab/raw/master/logos/SingleCellSchool_Docker.png){width="500px"}
...
See the [precourse material](../home_precourse.qmd)
