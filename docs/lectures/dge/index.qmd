...
- Detection hurdle + Expression hurdle
- Supports complex modelling
...
#     ggpubr::stat_compare_means(label.y = 8, size = 3),
#   rel_widths = c(3,2))
```
...
- How many cells/samples do I need for reliable DGE?
  ...
  - How high is the expression and how deeply am I sequencing?
