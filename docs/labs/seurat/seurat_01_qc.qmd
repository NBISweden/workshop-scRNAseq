...
if (!file.exists(path_file)) download.file(url = file.path(path_data, "covid/results_seurat/seurat_covid_qc_doublets.rds"), destfile = path_file, method = "curl", extra = curl_upass)
