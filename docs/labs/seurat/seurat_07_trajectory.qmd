...
In addition there was some manual filtering done to remove clusters that are disconnected and cells that are hard to cluster, which can be seen in this  [script](https://github.com/NBISweden/workshop-scRNAseq/blob/main/scripts/data_processing/slingshot_preprocessing.Rmd) 
...
vars <- c("Cd34", "Ms4a1", "Cd3e", "Ltf", "Cst3", "Cpa3", "Alas2", "Siglech", "C1qc", "Pf4")
pl <- list()
...
new_clust[new_clust == "26"] = "26-MastBaso" # Mast cells / Basophils
...
# Define lineage ends
ENDS <- c("17-Gran", "27-DC", "25-Mac", "16-TC", "26-MastBaso", "53-Mega", "49-RBC")
...
If you want to know more about how to control for this issue, please have a look at [batch_corrected_counts.Rmd](https://github.com/NBISweden/workshop-scRNAseq/blob/main/scripts/data_processing/batch_corrected_counts.Rmd)
