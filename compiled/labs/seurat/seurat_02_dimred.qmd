...
plotExplanatoryPCs(sce, nvars_to_plot = 15, npcs_to_plot = 20)

```



orig,ident (and ident) clearly contributes to many of the PCs, 
...
``` {r, eval=FALSE}
#OBS! Skip for now, known issue with later version of umap-learn 
# have 0.5.6
# need to downgrade to 0.5.4, but could mess up things with numpy. 
