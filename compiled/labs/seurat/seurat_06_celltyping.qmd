...
We have dowloaded the celltype gene lists from
...
``` {r}
if (!dir.exists("data/cellmarker")){ dir.create("data/cellmarker")}
if (!file.exists("data/cellmarker/Cell_marker_Human.csv")){
  download.file(
    url = "https://export.uppmax.uu.se/naiss2023-23-3/workshops/scRNAseq/misc/Cell_marker_Human.csv",
    destfile = "data/cellmarker/Cell_marker_Human.csv"
  )
}

# Load the human marker table
markers <- read.delim("data/cellmarker/Cell_marker_Human.csv", sep = ";")
...
markers <- markers [ markers$tissue_type %in% c("Blood","Venous blood",
                                                "Serum","Plasma",
